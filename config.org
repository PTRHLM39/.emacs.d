...
#+END_SRC
** IDE-layout
Will look similar to vscode-layout when editing C, go and lisp.
- Toggled with key-sequence ex. C-c i c for c-languages or C-c i l for lisp
*** File-browser-tree
Tree-macs
*** Linenumbers
#+BEGIN_SRC emacs-lisp
...
Ansi-term
*** Debugger
Some debugger through ansi-term 
*** Stackoverflow
