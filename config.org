...
#+END_SRC
** IDE-layout
VScode is great, but still emacs is a bit greater as an editor, imo.

The objective in this section, is to make the emacs build look similar to vscode's layout.
*** File-browser
#+BEGIN_SRC emacs-lisp
